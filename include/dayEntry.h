...
private:
    ...
    bool m_sexualRelationMorning;            // [x]
    bool m_sexualRelationDay;                // [x]
    bool m_sexualRelationEvening;            // [x]
...
public:
    ...
    bool setSexualRelationMorning(bool);
    bool setSexualRelationDay(bool);
    bool setSexualRelationEvening(bool);
    ...
    // READING THE DATA
    int getMenstruation();
    bool getSexualRelationMorning();
    bool getSexualRelationDay();
    bool getSexualRelationEvening();
