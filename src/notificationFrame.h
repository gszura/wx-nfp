...
public:
     notificationFrame(wxWindow *parent, configClass *config, const wxString& message, int textAlign, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, wxWindowID id = 1, const wxString &title = wxT("wx-nfp_notification"), long style = notificationFrame_STYLE);
