...
public:
     ...
     wxButton* buttonCoitusRecordPlus;
     ...
     wxButton* buttonCoitusRecordMinus;
     ...
     wxStaticText* staticCoitusRecord;
     wxStaticText* changesCoitusRecord;
...
protected:
     ...
     static const long ID_staticCoitusRecord;
     static const long ID_textCoitusRecord;
     static const long ID_buttonCoitusRecordMinus;
     static const long ID_buttonCoitusRecordPlus;
     static const long ID_changesCoitusRecord;
...
private:
     ...
     void buttonCoitusRecordMinusClick( wxCommandEvent& event );
     void buttonCoitusRecordPlusClick( wxCommandEvent& event );
