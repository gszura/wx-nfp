...
void notificationFrame::CreateGUIControls(const wxString& message, int textAlign)
{
     ...
     panel1 = new wxPanel( this, ID_panel1, wxPoint( 0, 0 ), wxSize( 270, 150 ) );
     ...
     text1 = new wxStaticText( panel1, ID_text1, message, wxPoint( 5, 5 ), wxSize( 250, 100 ), textAlign | wxST_NO_AUTORESIZE, _T( "text1" ) );
     ...
     buttonClose = new wxButton( panel1, ID_buttonClose, _( "Close" ), wxPoint( 5, 95 ), wxSize( 250, 25 ), wxNO_BORDER, wxDefaultValidator, _T( "buttonClose" ) );
